...
class DiT(nn.Module):
    ...
    def __init__(
        self,
        in_channels=7,
        hidden_size=1152, # not used
        depth=28,
        num_heads=16,
        mlp_ratio=4.0,
        class_dropout_prob=0.1, # please set to 0 if don't want to use uncondition/cfg
        token_size=4096,
        ...
        assert learn_sigma == False, "learn_sigma must be False"
