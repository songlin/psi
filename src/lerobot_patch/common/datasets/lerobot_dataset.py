...
import os
import sys
# SONGLIN: HACK to mute ffmpeg logs
class SilenceStdStreams:
    def __enter__(self):
        self._stdout_fd = sys.stdout.fileno()
        self._stderr_fd = sys.stderr.fileno()
        self._stdout_saved = os.dup(self._stdout_fd)
        self._stderr_saved = os.dup(self._stderr_fd)
        self._devnull = os.open(os.devnull, os.O_WRONLY)
        os.dup2(self._devnull, self._stdout_fd)
        os.dup2(self._devnull, self._stderr_fd)
        os.close(self._devnull)
    def __exit__(self, exc_type, exc_val, exc_tb):
        os.dup2(self._stdout_saved, self._stdout_fd)
        os.dup2(self._stderr_saved, self._stderr_fd)
